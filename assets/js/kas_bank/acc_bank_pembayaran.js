...
function add_detail() {
    ...
    total = parseFloat($('#total_pembayaran').val()) + parseFloat($('#jumlah').val());
...
function add() {
    ...
    $('.modal-title').text('Tambah Pembayaran (Kas & Bank)'); // Set Title to Bootstrap modal title
}
...
function edit(id) {
    ...
    $.ajax({
        ...
        success: function(data) { 
            ...
            $('.modal-title').text('Edit Pembayaran (Kas & Bank)'); // Set title to Bootstrap modal title 
        },
