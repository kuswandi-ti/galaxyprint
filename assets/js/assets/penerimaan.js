...
$(document).ready(function() {
    ...
    table = $('#table').DataTable({ 
        ...
        "ajax": {
            "url": base_url+'Assets/Penerimaan/ajax_list',
            "type": "POST"
        },
...
function edit(id)
{
    ...
    $.ajax({
        url : base_url+"Assets/Penerimaan/ajax_edit/" + id,
        type: "GET",
        dataType: "JSON",
...
function save()
{
    ...
    if(save_method == 'add') {
        url = base_url+"Assets/Penerimaan/ajax_add";
    } else {
        url = base_url+"Assets/Penerimaan/ajax_update";
    }
...
function hapus(id)
{
    if(confirm('Are you sure delete this data?'))
    {
        ...
        $.ajax({
            url : base_url+"Assets/Penerimaan/ajax_delete/"+id,
            type: "POST",
            dataType: "JSON",
            success: function(data)
            {
