                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                <select class="full-width select2" required data-init-plugin="select2" id='param' name="param">
                                                    <option>-- Pilih Jenis Laporan --</option>
                                                    <option value="b">Buku Besar (Rinci)</option>
                                                    <option value="n">Neraca Saldo</option>
                                                    <option value="l">Laba/Rugi (Standart)</option>
                                                </select>
                                                <span class="help-block"></span>
                                            </div>
                                        </div>
