                ...
                <div class="card-header ">
                    <div class="card-body">
                        <div class="col-lg-12 table-responsive">
                            <table class="judul">
                                <tr>
                                    <td><b>LAPORAN PENGELUARAN BARANG PERDOKUMEN PABEAN</b></td>
                            ...
                            <table width="100%" border="1" cellspacing="0" cellpadding="0" class="table">
                                <thead>
                                    <tr>
                                        <th colspan="4" style="text-align:center;vertical-align:middle;">DOKUMEN PABEAN</th>
                                        <th colspan="2" style="text-align:center;vertical-align:middle;">BUKTI PENGELUARAN BARANG</th>
                                        <th rowspan="2" style="text-align:center;vertical-align:middle;">PENERIMA BARANG</th>
                                        ...
                                        <th rowspan="2" style="text-align:center;vertical-align:middle;">SAT</th>
                                        <th rowspan="2" style="text-align:center;vertical-align:middle;">JML</th>
                                        <th rowspan="2" style="text-align:center;vertical-align:middle;">VALAS</th>
                                        <th rowspan="2" style="text-align:center;vertical-align:middle;">NILAI PABEAN</th>
                                    </tr>
                                    <tr>
