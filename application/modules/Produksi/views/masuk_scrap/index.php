        ...
        <div class=" container-fluid   container-fixed-lg bg-white">
            <div class="card card-transparent">
                <div class="card-header ">
                    <div class="card-title">Daftar Barang Sisa (Scrap)</div>
                    <hr>
                    <div class="card-body">
                        <div class="col-xs-12">
                            <button class="btn btn-success" onclick="add()"><i class="fa fa-plus"></i> Tambah Barang Sisa (Scrap)</button>
                        ...
                        <table id="tbl_detail" style="width: 100%">
                            ...
                            <tfoot>
                                ...
                                <tr>
                                    ...
                                    <td class="text-right">
                                        <input name="total_scrap" id="total_scrap" placeholder="" class="form-control text-right" type="text" value="0" readonly>
                                    </td>
                                </tr>
                            </tfoot>
                        </table>
