...
class Sto_Scrap extends MX_Controller {

    public $data;

    var $module                 = 'produksi';
    var $title                  = 'Stok Opname Scrap';
    var $file_name              = 'sto_scrap';
    var $table                  = 'trans_stockopname_scrap';
    ...
    public function ajax_list() {
        ...
        foreach ($list as $r) {
            ...
            $row[] = '<a class="btn btn-sm btn-primary btn-xs" href="javascript:void(0)" title="Edit" onclick="edit('."'".$r->id."'".')"><i class="fa fa-pencil"></i> Edit</a>
                      ...
                      <button type="button" class="btn btn-sm btn-danger btn-xs" href="javascript:void(0)" title="Unduh" onclick="unduh('."'".$r->id."'".')"><i class="fa fa-download"></i> Delete</button>';
