...
class Masuk_Material_Model extends CI_Model {
 
    var $table_header           = 'trans_masuk_material_header';
    var $table_detail           = 'trans_masuk_material_detail';

    var $query_header           = 'qtrans_masuk_material_header';
    var $query_detail           = 'qtrans_masuk_material_detail';

    var $table_supplier         = 'master_supplier';
    var $table_warehouse        = 'master_gudang';    
    ...
    var $table_po_header        = 'trans_po_header';

    var $column_order = array('tgl_masuk','supplier_id','supplier_name','no_po','no_invoice',
                              'no_packinglist','jenis_dokumen','no_aju','no_dokumen','tgl_dokumen',null);
    var $column_search = array('tgl_masuk','supplier_id','supplier_name','no_po','no_invoice',
                               'no_packinglist','jenis_dokumen','no_aju','no_dokumen','tgl_dokumen');
