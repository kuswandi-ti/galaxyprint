        ...
        <div class=" container-fluid   container-fixed-lg bg-white">
            <div class="card card-transparent">
                <div class="card-header ">
                    <div class="card-title">Daftar Penerimaan (Kas & Bank)</div>
                    <hr>
                    <div class="card-body">
                        <div class="col-xs-12">
                            <button class="btn btn-success" onclick="add()"><i class="fa fa-plus"></i> Tambah Penerimaan (Kas & Bank)</button>
                        ...
                        <div class="container-fluid">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="row">
                                        <label class="control-label col-md-3">Deposit To</label>
                                        <div class="col-md-6">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-9">
                                            <textarea class="form-control" id="pengirim" name="pengirim"></textarea>
                                            <span class="help-block"></span>
                                        </div>
                                    </div>
                                </div>
