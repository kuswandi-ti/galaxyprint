...
class Acc_bank_penerimaan_Model extends CI_Model {
    ...
    var $query_header           = 'qacc_bank_penerimaan_header';
    var $query_detail           = 'qacc_bank_penerimaan_detail';

    var $table_akun             = 'acc_master_akun';

    var $column_order = array('tgl_penerimaan','total_penerimaan','pengirim','keterangan',null);
    var $column_search = array('tgl_penerimaan','total_penerimaan','pengirim','keterangan');
