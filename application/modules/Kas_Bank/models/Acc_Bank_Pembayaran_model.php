...
class Acc_Bank_Pembayaran_Model extends CI_Model {
 
    var $table_header           = 'acc_bank_pembayaran_header';
    var $table_detail           = 'acc_bank_pembayaran_detail';

    var $query_header           = 'qacc_bank_pembayaran_header';
    var $query_detail           = 'qacc_bank_pembayaran_detail';

    var $table_akun             = 'acc_master_akun';

    var $column_order = array('tgl_pembayaran','total_pembayaran','penerima','keterangan',null);
    var $column_search = array('tgl_pembayaran','total_pembayaran','penerima','keterangan');
